...
> **Structure:** 4 Major Parts (A-B-C-D), Total 121 Measures, 7'42"  
...
본 시스템은 최적의 유지보수와 프로페셔널한 아키텍처 관리를 위해, 메인 실행 패치와 독립된 하위 추상화 패치(Abstraction Patches)들로 완전하게 모듈화(Modular Architecture)되어 `patchers/` 폴더 내에서 관리됩니다.
